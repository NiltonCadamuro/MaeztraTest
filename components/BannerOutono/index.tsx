    ...
    <section className="px-[31px] lg:px-4 mt-[7px] mb-10 lg:mt-16 lg:mb-20">
      <div className="flex flex-col lg:flex-row gap-6 justify-between lg:items-center container">
        <div className="w-full lg:max-w-[420px]">
          <h3 className="text-textTertiary font-bold text-2xl leading-[37px] mb-4">
            Lorem ipsum{" "}
          </h3>
          <p className="block lg:hidden text-textTertiary text-sm leading-[21.5px] pr-[29px]">
          ...
          <p className="hidden lg:block text-textTertiary text-sm leading-[21.5px]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Interdum
            mauris posuere fusce proin mattis. Hendrerit cras ut nunc enim
            dictum. Mattis proin ut quis donec sed eget nulla. Vel mi ut mauris
            integer. Nibh sagittis in lobortis sed cursus condimentum velit
